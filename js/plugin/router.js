...
function router(obj){
    ...
    if(obj && obj.constructor === Object){
        ...
        /**
         * 设置title，必须为函数，函数接收一个参数，为当前router对象
         */
        this.setTitle = function () {
            if(obj.title && obj.title.constructor === Function){
                obj.title(that.showRouter);
            }
        }

        /**
         * 增加拦截器，在进行路由之前拦截，返回true不做拦截，返回false拦截
         */
        this.interceptor = function (route) {
            if(obj.interceptor && obj.interceptor.constructor === Function){
                return obj.interceptor(route, that);
            }
            return true;
        }
                ...
                if(that.defaultPath){
                    ...
                    if(main.pathName){
                        ...
                        if(arr.length > 0){
                            ...
                            if(index){
                                that.selectIndex(index, main.pathParameter, true);
